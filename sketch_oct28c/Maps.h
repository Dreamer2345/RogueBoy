...
const uint8_t PROGMEM MAP_1[] = {
  ...
  0, 0,
  //MAP DATA
  9, 8, 8, 8, 8, 1, 11, 1, 1, 1, 1,
  1, 1, 1, 1, 8, 1, 8, 1, 1, 1, 1,
  8, 8, 8, 1, 8, 8, 8, 1, 1, 1, 1,
  8, 8, 8, 1, 8, 0, 8, 1, 1, 1, 1,
  8, 8, 8, 1, 8, 8, 8, 1, 1, 1, 1,
  8, 8, 8, 1, 8, 8, 8, 1, 1, 1, 1,
  8, 8, 8, 1, 8, 1, 2, 1, 1, 1, 1,
  8, 8, 8, 1, 8, 1, 8, 1, 1, 1, 1,
  8, 8, 8, 1, 8, 1, 3, 1, 1, 1, 1,
  8, 8, 8, 1, 8, 1, 1, 1, 1, 1, 1,
  8, 8, 8, 15, 8, 1, 1, 1, 1, 1, 1,
  //Number of Objects
  7,
  //Objects
  //<ID><xpos><ypos><Health>
